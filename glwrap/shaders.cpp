...
void Program::SetModel(glm::mat4 mat, bool transpose)
{
	glUniformMatrix4fv(model, 1, transpose, &mat[0][0]);
}


void Program::SetView(glm::mat4 mat, bool transpose)
{
	glUniformMatrix4fv(view, 1, transpose, &mat[0][0]);
}

void Program::SetProjection(glm::mat4 mat, bool transpose)
{
	glUniformMatrix4fv(projection, 1, transpose, &mat[0][0]);
}